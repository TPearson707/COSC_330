/* Potential solution to syncing clients
 * make a public function in client so that server can set text editabiliy
 * use a hashmap in Server to keep track of clients depending on letter allow one of the clients to edit the text input
 */ // 02/06/2025
